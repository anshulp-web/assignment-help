        ...
        <div class="row">
            ...
            <div class="col-md-6 col-xl-6">
                <div class="erp_contact_form_left_wrapper float_left" style="transform: translate(280px, 10px);">
                    ...
                    if (isset($_GET['/'])) {
                        $data = array('id' => '');
                        echo form_open_multipart('dashboard/updating_a_section1', $data);
                    } else {
                        $data = array('id' => '');
                        echo form_open_multipart('dashboard/adding_a_section1', $data);
                    }
                    ?>
                    ...
                    <div class="row">
                        ...
                        if (isset($_GET['/'])) {
                            ...
                            $base_url = base_url() . 'uploads/about-page-section1-images/' . $image;
