        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    <h5>Home page First Section Edit</h5>
                    <!-- <form  >
                ...
                <br><br>
                <a href="<?php echo base_url('dashboard/add_h_section1')?>" class="btn-lg btn-primary" style="margin-bottom:10px;">Add</a>
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <table class="table">
                        ...
                        ?>
                            <tr>
                                ...
                                <td><img src="<?php echo base_url()?>uploads/home-page-section1-images/<?php echo $value['img_url']?>" alt="image" width="200px" height="120px"></td>
                                
                                <td><a href="<?php echo base_url('dashboard/up_h_section1')?>?/=<?php echo $value['row_id']?>" class="btn btn-secondary">Update</a></td>
                                <td><a href="<?php echo base_url('dashboard/rm_h_section1')?>?/=<?php echo $value['row_id']?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this item?');">Remove</a></td>
